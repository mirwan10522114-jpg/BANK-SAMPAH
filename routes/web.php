...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Nasabah Bank Sampah
    Route::livewire('dashboard-saya', 'pages::nasabah.dashboard')->name('nasabah.dashboard');
    ...
    // Koperasi Member Panel
    Route::middleware('role:koperasi')
        ->prefix('koperasi')
        ->name('koperasi.member.')
        ->group(function () {
            Route::get('simpanan-saya', \App\Livewire\KoperasiMember\SimpananSaya::class)->name('simpanan');
            Route::get('pinjaman-saya', \App\Livewire\KoperasiMember\PinjamanSaya::class)->name('pinjaman');
        });
});
...
Route::middleware(['auth', 'verified', 'role:admin,owner'])
    ...
    ->group(function () {
        ...
        Route::livewire('manajemen-user', 'pages::admin.manajemen-user.index')->name('user.index');
