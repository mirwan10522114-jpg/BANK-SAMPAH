...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::app','data' => ['title' => __('Analytics Dashboard')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Analytics Dashboard'))]); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Nabung Baru','icon' => 'o-plus','link' => ''.e(route('admin.saving.create')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-primary btn-sm rounded-lg']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Sedekah Baru','icon' => 'o-heart','link' => ''.e(route('admin.sedekah.create')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-secondary btn-sm rounded-lg']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card c-green">
            ...
            <div style="font-size:26px;font-weight:800;color:var(--txt)"><?php echo e($rupiah($allSaving->val)); ?></div>
        ...
        <div class="kpi-card c-amber">
            ...
            <div style="font-size:26px;font-weight:800;color:var(--txt)"><?php echo e(number_format((float)$allSaving->wgt, 1, ',', '.')); ?> kg</div>
        ...
        <div class="kpi-card c-purple">
            ...
            <div style="font-size:26px;font-weight:800;color:var(--txt)"><?php echo e(number_format((float)$allSedekah->wgt, 1, ',', '.')); ?> kg</div>
        ...
        <div class="kpi-card c-teal">
            ...
            <div style="font-size:26px;font-weight:800;color:var(--txt)"><?php echo e(number_format($nasabahCount)); ?></div>
    ...
    <div style="display:grid; grid-template-columns:2fr 1fr; gap:24px; align-items:stretch;" class="grid-2col">
        ...
        <div class="panel">
            ...
            <div class="panel-body flex flex-col items-center justify-center" wire:ignore>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($catData) > 0): ?>
        ...
        <div class="panel">
            <div class="panel-header">
                ...
                <div style="text-align:right;">
                    <div style="font-size:18px; font-weight:800; color:var(--txt);"><?php echo e($rupiah($totalSaldo)); ?></div>
                    ...
                    <div class="flex-1 flex flex-col gap-3" style="min-width:200px;">
                        <div style="padding:16px; border-radius:12px; border:1px solid var(--bord); border-left:4px solid var(--a500); background:var(--surf);">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <span style="font-size:14px; font-weight:800; color:var(--txt);"><?php echo e($rupiah($totalTertahan)); ?></span>
                            </div>
                        ...
                        <div style="padding:16px; border-radius:12px; border:1px solid var(--g100); border-left:4px solid var(--g700); background:var(--g50);">
                            <div class="flex justify-between items-center mb-1">
                                ...
                                <span style="font-size:14px; font-weight:800; color:var(--g800);"><?php echo e($rupiah($totalTersedia)); ?></span>
                            </div>
    ...
    <div class="panel">
        ...
        <div class="table-container">
            <table class="db-table" id="txTable">
                ...
                <tbody id="txBody">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recentTransactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    ?>
                    <tr data-name="<?php echo e(strtolower($userName)); ?>">
                        <td>
                            <div style="font-weight:600; color:var(--txt);"><?php echo e($tx['transacted_at']->format('d M Y')); ?></div>
                            <div style="font-size:12px; color:var(--muted); margin-top:2px;"><?php echo e($tx['transacted_at']->format('H:i')); ?> WIB</div>
                        </td>
                        <td>
                            <div class="flex items-center gap-3">
                                <div style="width:36px; height:36px; border-radius:50%; display:flex; align-items:center; justify-content:center; font-weight:700; font-size:12px; background:<?php echo e($bgIcon); ?>; color:<?php echo e($clrIcon); ?>; flex-shrink:0;">
                                    <?php echo e($initials); ?>

                                </div>
                                <div>
                                    <div style="font-weight:600; color:var(--txt);"><?php echo e($userName); ?></div>
                                    <div style="font-size:12px; color:var(--muted); margin-top:2px;"><?php echo e($userEmail); ?></div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($tx['categories'])): ?>
                                <div style="display:flex; flex-wrap:wrap; gap:4px;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tx['categories']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <span style="background:#f1f5f9; border:1px solid #e2e8f0; color:#475569; padding:3px 8px; border-radius:5px; font-size:11px; font-weight:600; white-space:nowrap;"><?php echo e($cat); ?></span>
                        ...
                        <td>
                            <span style="font-weight:700; color:var(--txt); font-size:14px;"><?php echo e(number_format((float)$tx['total_weight'], 2, ',', '.')); ?></span>
                            <span style="font-size:12px; color:var(--muted);"> kg</span>
                        </td>
                        <td>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isSedekah): ?>
                                <span style="font-weight:700; color:var(--g800); font-size:14px;"><?php echo e($rupiah((float)$tx['total_value'])); ?></span>
                            <?php else: ?>
...
// DATA DARI BACKEND
// ==========================================
const rawMonthsData = <?php echo json_encode($months12, 15, 512) ?>;
const topNasabahRaw = <?php echo json_encode($topNasabahData, 15, 512) ?>;
const catLabels     = <?php echo json_encode($catLabels, 15, 512) ?>;
const catData       = <?php echo json_encode($catData, 15, 512) ?>;
    ...
    try {
        ...
        donutChart = new Chart(ctx4, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($totalTertahan); ?>, <?php echo e($totalTersedia); ?>],
...
<?php endif; ?><?php /**PATH C:\laragon\www\BANK-SAMPAH\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>