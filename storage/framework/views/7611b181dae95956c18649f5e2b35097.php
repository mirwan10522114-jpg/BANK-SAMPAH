...
<?php $component = Mary\View\Components\Header::resolve(['title' => ''.e(__('Pencairan')).'','subtitle' => ''.e(__('Riwayat pencairan saldo Anda via cash atau transfer.')).'','separator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Table::resolve(['headers' => $this->headers,'rows' => $this->withdrawals,'withPagination' => true,'striped' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
        ...
        <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_processed_at_label', function($row) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <?php echo e($row->processed_at->format('d M Y H:i')); ?>

        <?php }); ?>

        <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_amount_label', function($row) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <span class="font-semibold">Rp <?php echo e(number_format((float) $row->amount, 0, ',', '.')); ?></span>
        <?php }); ?>

        <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_method_label', function($row) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->method === 'transfer'): ?>
...
<?php $component = Mary\View\Components\Badge::resolve(['value' => ''.e(__('Transfer')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->bank_name): ?>
                    <div class="text-xs text-base-content/60 mt-1">
                        <?php echo e($row->bank_name); ?> • <?php echo e($row->account_number); ?>
            ...
            <?php else: ?>
                <?php if (isset($component)) { $__componentOriginal4f015fb6508e425790bdb8f79792e6ed = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4f015fb6508e425790bdb8f79792e6ed = $attributes; } ?>
<?php $component = Mary\View\Components\Badge::resolve(['value' => ''.e(__('Cash')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mary-badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
        ...
        <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('cell_notes', function($row) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <span class="text-sm text-base-content/70"><?php echo e($row->notes ?? '—'); ?></span>
        <?php }); ?>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</section><?php /**PATH C:\laragon\www\BANK-SAMPAH\storage\framework/views/livewire/views/2762ddf0.blade.php ENDPATH**/ ?>